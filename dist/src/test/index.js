...
describe("PDF Jsig tests", function () {
    var jwk1;
    var jwk2;
    var did1;
    var did2;
    ...
    describe("Verification tests", function () {
        it("Signed PDF verification should pass", function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, pdfVerifier.verifySignedPdf(pdf1Signed)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        it("Verification of PDF signed twice should pass", function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, pdfVerifier.verifySignedPdf(pdf1SignedTwice)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
